  ...
  return (
    <section className="max-w-[1900px] mx-auto relative bg-[#fff8ee]">
      ...
      <div className="relative">
        ...
        <div className="absolute md:top-1/4 bottom-[10%] left-[16px] md:left-[60px] md:max-w-[700px] max-w-[100%] z-10">
          <h1 className="md:text-[52px] md:leading-[52px] text-[28px] md:mb-[36px] mb-[16px] leading-[28px] text-[#2c2c2c] font-normal">
          ...
          <div className="flex md:gap-[20px] gap-[16px]">
            <Link
              href="/coming-soon"
