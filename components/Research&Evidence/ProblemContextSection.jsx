...
const ProblemContextSection = ({
    ...
    cards = [
        {
            title: "Issue",
            desc: "Gap in Foundational Well-being and Emotional-Cognitive Preparedness",
            img: assets.ProbCtxt1,
        },
        {
            title: "Why Care?",
            desc: "We risk sacrificing lifelong flourishing and accelerating future societal challenges",
            img: assets.ProbCtxt2,
        },
        {
            title: "How does research help?",
            desc: "Continuous data is our commitment to sustained impact",
            img: assets.ProbCtxt3,
        },
    ]
}) => {
    ...
    return (
        <section className="max-w-[1500px] mx-auto px-[0px] md:px-[60px] md:py-[60px] py-[30px] text-center overflow-hidden">
            <h2 className="max-md:px-[16px]">{heading}</h2>

            <p className="text-[#2C2C2C] text-[16px] md:text-[20px] leading-[24px] md:leading-[30px] font-[400] pt-[15px] md:pb-[30px] pb-[20px] max-md:px-[16px]">
                {description}
            </p>
